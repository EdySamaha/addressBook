...
"""NOTE: Should get Models from register.models NOT put them here since it will be considered different models"""
...
#     orgname = models.CharField(max_length=20, blank=True) #blank=True for login (not required)
